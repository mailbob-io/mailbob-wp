			...
			createElement( Panel, {},
				...
				createElement( PanelBody, {
						...
						createElement( RangeControl, {
							...
							paddingMin: '0',
							paddingMax: '100',
							onChangePadding: (value) => setAttributes( { paddingTop: value } ),
						} ),
						createElement( RangeControl, {
							...
							paddingMin: '0',
							paddingMax: '100',
							onChangePadding: (value) => setAttributes( { paddingBottom: value } ),
						} ),
						createElement( RangeControl, {
							...
							paddingMin: '0',
							paddingMax: '100',
							onChangePadding: (value) => setAttributes( { paddingLeft: value } ),
						} ),
						createElement( RangeControl, {
							...
							paddingMin: '0',
							paddingMax: '100',
							onChangePadding: (value) => setAttributes( { paddingRight: value } ),
						} ),
					), createElement( PanelRow, {},
						createElement( RangeControl, {
							...
							marginMin: '0',
							marginMax: '100',
							onChangemargin: (value) => setAttributes( { marginTop: value } ),
						} ),
						createElement( RangeControl, {
							...
							marginMin: '0',
							marginMax: '100',
							onChangemargin: (value) => setAttributes( { marginBottom: value } ),
						} ),
						createElement( RangeControl, {
							...
							marginMin: '0',
							marginMax: '100',
							onChangemargin: (value) => setAttributes( { marginLeft: value } ),
						} ),
						createElement( RangeControl, {
							...
							marginMin: '0',
							marginMax: '100',
							onChangemargin: (value) => setAttributes( { marginRight: value } ),
						} ),
					), createElement( PanelRow, {},
